...
try{
	...
	if (a.equals("I")){ // Display
		String strsql = "SELECT * FROM `genero` WHERE " + sqlKey;
		...
		String strsql = "DELETE FROM `genero` WHERE " + sqlKey;
...
<p><span class="jspmaker">Delete from TABLE: genero<br><br><a href="generolist.jsp">Back to List</a></span></p>
<form action="generodelete.jsp" method="post">
<p>
...
%>
	...
	<input type="hidden" name="key" value="<%= HTMLEncode(key) %>">
		<td class="<%= rowclass %>"><% out.print(x_id_genero); %>&nbsp;</td>
		<td class="<%= rowclass %>"><% out.print(x_nombreg); %>&nbsp;</td>
  </tr>
<%
}
rs.close();
