...
try{
	...
	if (rs.getString("nombrepersonaje") != null){
		...
		// Open record
		String strsql = "SELECT * FROM `reparto` WHERE 0 = 1";
		rs = stmt.executeQuery(strsql);
		rs.moveToInsertRow();
		...
		String srchfld = "'" + tmpfld + "'";
			...
			strsql = "SELECT * FROM `reparto` WHERE `nombrepersonaje` = '" + srchfld +"'";
			...
			if (rschk.next()) {
				out.print("Duplicate key for nombrepersonaje, value = " + tmpfld + "<br>");
...
<p><span class="jspmaker">Add to TABLE: reparto<br><br><a href="repartolist.jsp">Back to List</a></span></p>
...
<form onSubmit="return EW_checkMyForm(this);"  action="repartoadd.jsp" method="post">
<p>
<input type="hidden" name="a" value="A">
<table class="ewTable">
	<tr>
		<td class="ewTableHeader">id pro&nbsp;</td>
		<td class="ewTableAltRow"><% if (x_id_pro== null || ((String)x_id_pro).equals("")) {x_id_pro = "0"; } // set default value %><%
...
&nbsp;</td>
	...
	<tr>
		...
		<td class="ewTableAltRow"><% if (x_id_actor== null || ((String)x_id_actor).equals("")) {x_id_actor = "0"; } // set default value %><%
