...
try{
	...
	if (rs.getClob("p9Descripcion") != null) {
		...
		// Open record
		String strsql = "SELECT * FROM `corporativo` WHERE 0 = 1";
		rs = stmt.executeQuery(strsql);
		rs.moveToInsertRow();
...
<p><span class="jspmaker">Add to TABLE: corporativo<br><br><a href="corporativolist.jsp">Back to List</a></span></p>
...
<form onSubmit="return EW_checkMyForm(this);"  action="corporativoadd.jsp" method="post">
<p>
