...
try{
	...
	x_id_genero = String.valueOf(rs.getLong("id_genero"));
		...
		// Open record
		String strsql = "SELECT * FROM `produccion` WHERE 0 = 1";
		rs = stmt.executeQuery(strsql);
		rs.moveToInsertRow();
		...
		String srchfld = tmpfld;
			...
			strsql = "SELECT * FROM `produccion` WHERE `id_pro` = " + srchfld;
			...
			if (rschk.next()) {
				out.print("Duplicate key for id_pro, value = " + tmpfld + "<br>");
...
<p><span class="jspmaker">Add to TABLE: produccion<br><br><a href="produccionlist.jsp">Back to List</a></span></p>
...
<form onSubmit="return EW_checkMyForm(this);"  action="produccionadd.jsp" method="post">
<p>
<input type="hidden" name="a" value="A">
<table class="ewTable">
	<tr>
		<td class="ewTableHeader">id pro&nbsp;</td>
		<td class="ewTableAltRow"><% if (x_id_pro== null || ((String)x_id_pro).equals("")) {x_id_pro = "0"; } // set default value %><input type="text" name="x_id_pro" size="30" value="<%= HTMLEncode((String)x_id_pro) %>">&nbsp;</td>
	</tr>
	<tr>
