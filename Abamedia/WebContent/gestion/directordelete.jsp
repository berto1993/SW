...
try{
	...
	if (a.equals("I")){ // Display
		String strsql = "SELECT * FROM `director` WHERE " + sqlKey;
		...
		String strsql = "DELETE FROM `director` WHERE " + sqlKey;
...
<p><span class="jspmaker">Delete from TABLE: director<br><br><a href="directorlist.jsp">Back to List</a></span></p>
<form action="directordelete.jsp" method="post">
<p>
...
%>
	...
	<input type="hidden" name="key" value="<%= HTMLEncode(key) %>">
		<td class="<%= rowclass %>"><% out.print(x_id_di); %>&nbsp;</td>
		<td class="<%= rowclass %>"><% out.print(x_nombred); %>&nbsp;</td>
  </tr>
<%
}
rs.close();
