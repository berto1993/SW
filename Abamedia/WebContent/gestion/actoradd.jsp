...
try{
	...
	if (rs.getString("nombrea") != null){
		...
		// Open record
		String strsql = "SELECT * FROM `actor` WHERE 0 = 1";
		rs = stmt.executeQuery(strsql);
		rs.moveToInsertRow();
...
<p><span class="jspmaker">Add to TABLE: actor<br><br><a href="actorlist.jsp">Back to List</a></span></p>
...
<form onSubmit="return EW_checkMyForm(this);"  action="actoradd.jsp" method="post">
<p>
